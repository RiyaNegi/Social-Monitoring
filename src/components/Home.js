    ...
    return (
        <div className="homepage">
            <div className="home-nav">
                <div className="home-name ml-6 mt-4">Social Sprout </div>
            ...
            <div className="home-text mt-4">Analyse and Understand how the internet perceives your brand. <br />Create the best possible persona for your brand on the internet with this visualization tool.</div>
